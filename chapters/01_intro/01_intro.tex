	...
	\subsection[ABP simulations]{Physics and Numerical Simulations of ABPs}
		...
		\begin{algorithm}
			...
			\begin{algorithmic}[1]
				...
				\State{$ \vec{r}_{i,n+1}\gets \vec{r_n} + w_{i,n} + \frac{\Delta t}{2}\left[v (\cos\theta_{i,n}, \sin\theta_{i,n}) + \vec{F}_{i,n} / \gamma _t + v (\cos\theta_{i,\hat{n}}, \sin\theta_{i,\hat{n}}) + \vec{F}_{i,\hat{n}} / \gamma _t\right] $}
